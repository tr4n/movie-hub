    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `Favorite` (`id` INTEGER NOT NULL, `title` TEXT NOT NULL, `voteAverage` REAL NOT NULL, `genes` TEXT NOT NULL, `releaseYear` TEXT NOT NULL, `runTime` INTEGER NOT NULL, `posterPath` TEXT NOT NULL, PRIMARY KEY (`id`))');
...
class _$FavoriteDao extends FavoriteDao {
  ...
  @override
  Future<Favorite?> get(int id) async {
  ...
  Future<void> update(Favorite favorite) async {
    await _favoriteUpdateAdapter.update(favorite, OnConflictStrategy.abort);
  }
}
